...
//	char fname_dst[40];
	...
	char* dpath_dst = "images\\12_1";

	// dir path, time label,serial num, degrees
	char* fname_dst_skeleton = "%s\\s_12_1_1.i=lena.rotate-multiple.use-2-image-objects%s.(%d).%d-degrees.pgm";
...
}//s_12_1_2_rotate_images_x_times(int times)

void s_12_1_1_rotate_images_multiple_times__use_2_image_objects() {
...
void s_11_1_1_rotate_images_multiple_times__V3() {
...
//	s_11_1_1_rotate_images_multiple_times__V3();
